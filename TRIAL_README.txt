...
HOW TO START:
  Double-click start_protected.bat
  — or —
  Double-click AstroDestinyAnalyzer.exe
...
DISCLAIMER:
  This software is provided for self-exploration and entertainment purposes.
  All analysis results are for reference only and do not constitute scientific
  conclusions, medical diagnoses, investment advice, or absolute predictions.
